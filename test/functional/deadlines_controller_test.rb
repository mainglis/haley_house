...
class DeadlinesControllerTest < ActionController::TestCase
  ...
  test "should create deadline" do
    assert_difference('Deadline.count') do
      post :create, deadline: { date: @deadline.date, grant_record_id: @deadline.grant_record_id, notes: @deadline.notes, type: @deadline.type }
    end
  ...
  test "should update deadline" do
    put :update, id: @deadline, deadline: { date: @deadline.date, grant_record_id: @deadline.grant_record_id, notes: @deadline.notes, type: @deadline.type }
    assert_redirected_to deadline_path(assigns(:deadline))
  end
